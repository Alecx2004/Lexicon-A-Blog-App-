...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center w-full mt-2">
      <div
        className={`mx-auto w-full max-w-lg bg-gray-100 dark:bg-gray-800 rounded-xl my-7 p-10 border border-black/10`}
      >
        ...
        {error && (
          <p className="text-red-600 dark:text-red-400 mt-8 text-center">{error}</p>
        )}
